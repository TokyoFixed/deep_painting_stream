...
def head():
    ...
    st.markdown(f'<h1 style="text-align:center;margin-bottom:-30px;margin-top: -10px">{"Welcome To The Deep Painting App"}</h1>',
...
def example():
    st.markdown(f'<h2 style="text-align:center;margin-bottom:-25px;margin-top: 7px; font-size:23px;font-weight:bolder">{"Image examples from six different artistic movements"}</h2>',
                unsafe_allow_html=True)
...
def explanation_of_movements():
    ...
    if mov == 'Ukiyo-e':
        st.write('Ukiyo-e is a genre of Japanese art which flourished from the 17th through 19th centuries. Its artists produced woodblock prints \
                ...
                and fauna; and erotica. The term Ukiyo-e (浮世絵) translates as "pictures of the floating world".')
